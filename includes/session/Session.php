 ...
 * @package Doc-Site
 */
//namespace Couponsessions;

namespace App\includes\session;
/**
 * Class Session
 *
 * @package Couponsessions
 */
class Session
{
    /** @var string Key for session value array */
    protected $valuesKey = 'DocSite.session';
     ...
     * - name:    Name of the session                         (Default: Couponsessions)
     ...
     */
    protected function setDomain(string $domain = NULL)
    {
     ...
     * @return void
     */
    protected function setSecure(bool $secure = NULL)
    {
        $this->secure = $secure;
    }
     ...
     * @throws \Exception
     */
    protected function setHash(string $hash = NULL)
    {
    ...
    protected function generateDecoyCookie()
    {
        ...
        if ($this->decoy && !$has_decoy) {
            ...
            setcookie('PHPSESSID', $this->getValue('decoy_value'), [
                'expires' => time() * 3600,
                'path' => '/',
                'domain' => DOMAIN,
                'secure' => TRUE,
