...
class Facebook extends OAuth2
{
    ...
    public function getUserProfile()
    {
        ...
        $userProfile->photoURL = 'https://graph.facebook.com/' . $userProfile->identifier. '/picture';
    ...
    protected function fetchUserContact($item)
    {
        ...
        $userContact->photoURL = 'https://graph.facebook.com/' . $userContact->identifier . '/picture';
