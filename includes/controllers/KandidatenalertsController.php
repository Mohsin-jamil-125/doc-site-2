...
class KandidatenalertsController extends Controller {
    ...
    public function __construct($db, $config){
       ...
       $this->model = $this->model('Kandidatenalerts', $this->config, $this->db);
    }
    ...
    public function index($params = ''){
        ...
        $this->isPage = 'firma/kandidatenalerts';
        $params = func_get_args();
        $this->model->text['params'] = $params;

        $this->model->getAllAlerts();
